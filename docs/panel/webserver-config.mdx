    ...
    <TabItem value="nginx" label="Nginx">
        ...
        <Tabs>
            <TabItem value="ahttps" label="https">
                ...
                ```nginx {} title="/etc/nginx/sites-available/pelican.conf"
                server_tokens off;

                server {
                    listen 80;
                    server_name gp.bytenodes.com;
                ...
                server {
                    ...
                    ssl_certificate /etc/letsencrypt/live/gp.bytenodes.com/fullchain.pem;
                    ssl_certificate_key /etc/letsencrypt/live/gp.bytenodes.com/privkey.pem;
